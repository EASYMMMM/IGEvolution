...
from isaacgymenvs.tasks.SRLEvo.srl_hri_base import SRL_HRIBase, dof_to_obs
...
class SRL_HRI(SRL_HRIBase):
    ...
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        self._state_init = SRL_HRI.StateInit[state_init] # 初始化方式 （随机重启）
    ...
    def _reset_actors(self, env_ids):
        ...
        if (self._state_init == SRL_HRI.StateInit.Default):
            self._reset_default(env_ids)
        elif (self._state_init == SRL_HRI.StateInit.Start
              or self._state_init == SRL_HRI.StateInit.Random):
            self._reset_ref_state_init(env_ids)
        elif (self._state_init == SRL_HRI.StateInit.Hybrid):
    ...
    def _reset_ref_state_init(self, env_ids):
        ...
        if (self._state_init == SRL_HRI.StateInit.Random
            or self._state_init == SRL_HRI.StateInit.Hybrid):
