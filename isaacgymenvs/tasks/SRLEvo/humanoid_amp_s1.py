...
from isaacgymenvs.tasks.SRLEvo.humanoid_amp_s1_base import HumanoidAMP_s1_Base, dof_to_obs
...
class HumanoidAMP_s1(HumanoidAMP_s1_Base):
    ...
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        self._state_init = HumanoidAMP_s1.StateInit[state_init]
    ...
    def _reset_actors(self, env_ids):
        if (self._state_init == HumanoidAMP_s1.StateInit.Default):
            self._reset_default(env_ids)
        elif (self._state_init == HumanoidAMP_s1.StateInit.Start
              or self._state_init == HumanoidAMP_s1.StateInit.Random):
            self._reset_ref_state_init(env_ids)
        elif (self._state_init == HumanoidAMP_s1.StateInit.Hybrid):
    ...
    def _reset_ref_state_init(self, env_ids):
        ...
        if (self._state_init == HumanoidAMP_s1.StateInit.Random
            or self._state_init == HumanoidAMP_s1.StateInit.Hybrid):
