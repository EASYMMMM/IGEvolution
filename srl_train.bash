...
# check
python SRL_Evo_train.py task=SRLBot test=True    num_envs=8 checkpoint=runs/TRO_SRL_bot_v3_04-17-00-16/nn/TRO_SRL_bot_v3.pth  sim_device=cuda:0 rl_device=cuda:0      
...
# checkpoint sym loss
python SRL_Evo_train.py task=SRLBot wandb_project=TRO_SRL_Evo experiment=TRO_SRL_bot_v2  checkpoint=runs/TRO_SRL_bot_v2_17-18-32-10/nn/TRO_SRL_bot_v2.pth   headless=True wandb_activate=True max_iterations=2000  sim_device=cuda:0 rl_device=cuda:0 num_envs=4096    ; 