...
# check
python SRL_Evo_train.py task=SRLBot test=True    num_envs=8 checkpoint=runs/TRO_SRL_bot_v3_06-16-59-07/nn/TRO_SRL_bot_v3.pth  sim_device=cuda:0 rl_device=cuda:0      
...
# checkpoint training
python SRL_Evo_train.py task=SRLBot wandb_project=TRO_SRL_Evo experiment=TRO_SRL_bot_v3  checkpoint=runs/TRO_SRL_bot_v3_04-17-32-10/nn/TRO_SRL_bot_v3.pth   headless=True wandb_activate=True max_iterations=4000  sim_device=cuda:0 rl_device=cuda:0   ; 