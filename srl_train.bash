...
# check
python SRL_Evo_train.py task=SRLBot test=True    num_envs=4 checkpoint=runs/TRO_SRL_bot_v3_14-15-27-36/nn/TRO_SRL_bot_v3.pth  sim_device=cuda:0 rl_device=cuda:0 
...
# stage 1
python SRL_Evo_train.py task=SRLBot wandb_project=TRO_SRL_Evo experiment=TRO_SRL_bot_v3  checkpoint=runs/TRO_SRL_bot_v3_09-19-51-57/nn/TRO_SRL_bot_v3.pth  headless=True wandb_activate=True max_iterations=2000  sim_device=cuda:0 rl_device=cuda:0  train.params.config.a_sym_loss_coef=1.0 ; 

# stage 2
python SRL_Evo_train.py task=SRLBot wandb_project=TRO_SRL_Evo experiment=TRO_SRL_bot_v3  checkpoint=runs/TRO_SRL_bot_v3_13-17-34-06/nn/TRO_SRL_bot_v3.pth  headless=True wandb_activate=True max_iterations=3000  sim_device=cuda:0 rl_device=cuda:0  train.params.config.a_sym_loss_coef=1.0 ; 