...
# check
python SRL_Evo_train.py task=SRLBot test=True    num_envs=4 checkpoint=runs/SRL_bot_v4_s1_15-15-34-42/nn/SRL_bot_v4_s1.pth   sim_device=cuda:0 rl_device=cuda:0 
...
# srl model v3 check
python SRL_Evo_train.py task=SRLBot test=True    num_envs=4 checkpoint=runs/TRO_SRL_bot_v3_16-21-04-35/nn/TRO_SRL_bot_v3.pth  sim_device=cuda:0 rl_device=cuda:0  task.env.asset.assetFileName="mjcf/srl_bot/srl_bot_inversed_v3.xml"
...
# stage 1
python SRL_Evo_train.py task=SRLBot wandb_project=TRO_SRL_Evo experiment=SRL_bot_v4_s1  headless=True wandb_activate=True max_iterations=1000  sim_device=cuda:0 rl_device=cuda:0  train.params.config.a_sym_loss_coef=0.0    ;  
