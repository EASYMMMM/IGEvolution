...
# --- check ---
python SRL_Evo_train.py task=SRL_Real_Bot test=True force_render=True task.env.cameraFollow=True num_envs=4 task.env.task_training_stage=1 checkpoint=runs/SRL_Real_s0_22-14-01-48/nn/SRL_Real_s0.pth  sim_device=cuda:1 rl_device=cuda:1  
# --- stage 2 --- vel+hei
python SRL_Evo_train.py task=SRL_Real_Bot wandb_project=SRL_Real experiment=SRL_Real_s2  task.env.task_training_stage=2 headless=True wandb_activate=True max_iterations=1500    checkpoint=runs/SRL_Real_s0_22-14-01-48/nn/SRL_Real_s0.pth  task.env.pelvis_height_reward_scale=8.0 task.env.vel_tracking_reward_scale=8.0  task.env.progress_reward_scale=0.0 ;  
# --- check ---
python SRL_Evo_train.py task=SRL_Real_Bot test=True force_render=True task.env.cameraFollow=True num_envs=4 task.env.task_training_stage=2 checkpoint=runs/SRL_Real_s2_22-19-41-14/nn/SRL_Real_s2.pth  sim_device=cuda:1 rl_device=cuda:1  
# --- stage 3 --- vel+hei+ori
...
# --- check ---
python SRL_Evo_train.py task=SRL_Real_Bot test=True force_render=True task.env.cameraFollow=True num_envs=4 task.env.task_training_stage=3 task.task.randomize=True checkpoint=runs/SRL_Real_s4_26-17-10-46/nn/SRL_Real_s4.pth  sim_device=cuda:1 rl_device=cuda:1  
