...
# --- check ---
python SRL_Evo_train.py task=SRL_Real_Bot test=True force_render=True task.env.cameraFollow=True num_envs=4 task.env.task_training_stage=1 checkpoint=runs/SRL_Real_s1_09-15-38-43/nn/SRL_Real_s1.pth  sim_device=cuda:1 rl_device=cuda:1  task.env.asset.assetFileName="mjcf/srl_real/srl_real_bot_v1.xml" task.env.srl_max_effort=150
# --- stage 1.5 --- vel+motor
...
# --- check ---
python SRL_Evo_train.py task=SRL_Real_Bot test=True force_render=True task.env.cameraFollow=True num_envs=4 task.env.task_training_stage=3 task.env.asset.assetFileName="mjcf/srl_real/srl_real_bot_v1.xml"  checkpoint=runs/SRL_Real_s3_03-15-03-23/nn/SRL_Real_s3.pth sim_device=cuda:1 rl_device=cuda:1 task.env.srl_max_effort=150; 
# --- stage 4 --- Domain Randomization 
python SRL_Evo_train.py task=SRL_Real_Bot wandb_project=SRL_Real experiment=SRL_Real_s4  task.env.task_training_stage=3 task.task.randomize=True task.task.vel_pertubation=True headless=True wandb_activate=True max_iterations=3500  task.env.asset.assetFileName="mjcf/srl_real/srl_real_bot_v1.xml"   checkpoint=runs/SRL_Real_s3_03-15-03-23/nn/SRL_Real_s3.pth  task.env.progress_reward_scale=0.0  task.env.srl_motor_cost_scale=1.0  task.env.alive_reward_scale=0.0  task.env.srl_max_effort=150;  
# --- check ---
python SRL_Evo_train.py task=SRL_Real_Bot test=True force_render=True task.env.cameraFollow=True num_envs=4 task.env.task_training_stage=3 task.task.randomize=True  task.task.vel_pertubation=True checkpoint=runs/SRL_Real_s4_04-15-07-52/nn/SRL_Real_s4.pth   sim_device=cuda:1 rl_device=cuda:1  task.env.asset.assetFileName="mjcf/srl_real/srl_real_bot_v1.xml" task.env.srl_max_effort=150


# --- check ---
python SRL_Evo_train.py task=SRL_Real_Bot test=True force_render=True task.env.cameraFollow=True num_envs=4 task.env.task_training_stage=1 checkpoint=runs/SRL_Real_s1_maxmotor150_03-11-35-15/nn/SRL_Real_s1_maxmotor150.pth  sim_device=cuda:1 rl_device=cuda:1  task.env.asset.assetFileName="mjcf/srl_real/srl_real_bot_v1.xml" task.env.srl_max_effort=180
