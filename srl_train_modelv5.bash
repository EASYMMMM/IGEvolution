...
# srl model v5 check
python SRL_Evo_train.py task=SRLBot test=True    num_envs=4 checkpoint=runs/SRL_bot_v5_s2_24-20-50-40/nn/SRL_bot_v5_s2.pth  sim_device=cuda:0 rl_device=cuda:0  task.env.asset.assetFileName="mjcf/srl_bot/srl_bot_inversed_v5.xml"
...
# stage 1 velocity
python SRL_Evo_train.py task=SRLBot wandb_project=TRO_SRL_Evo experiment=SRL_bot_v5_s1  headless=True wandb_activate=True max_iterations=2000  task.env.asset.assetFileName="mjcf/srl_bot/srl_bot_inversed_v5.xml"  train.params.config.a_sym_loss_coef=1.0  checkpoint=runs/SRL_bot_v5_s0_22-17-54-52/nn/SRL_bot_v5_s0.pth  task.env.vel_tracking_reward_scale=8  task.env.progress_reward_scale=0.0 task.env.alive_reward_scale=0.0;  

# stage 1 vel+ori
python SRL_Evo_train.py task=SRLBot wandb_project=TRO_SRL_Evo experiment=SRL_bot_v5_s1  headless=True wandb_activate=True max_iterations=2000  task.env.asset.assetFileName="mjcf/srl_bot/srl_bot_inversed_v5.xml"  train.params.config.a_sym_loss_coef=0.0  checkpoint=runs/SRL_bot_v5_s0_24-17-45-42/nn/SRL_bot_v5_s0.pth  task.env.orientation_reward_scale=6  task.env.progress_reward_scale=0.0 task.env.alive_reward_scale=0.0;  


# stage 2 vel+ori+height
python SRL_Evo_train.py task=SRLBot wandb_project=TRO_SRL_Evo experiment=SRL_bot_v5_s2  headless=True wandb_activate=True max_iterations=3000  task.env.asset.assetFileName="mjcf/srl_bot/srl_bot_inversed_v5.xml"  train.params.config.a_sym_loss_coef=0.0  checkpoint=runs/SRL_bot_v5_s1_24-18-08-29/nn/SRL_bot_v5_s1.pth  task.env.vel_tracking_reward_scale=7 task.env.pelvis_height_reward_scale=3.0 task.env.progress_reward_scale=0.0 task.env.alive_reward_scale=0.0;  

# stage 2
python SRL_Evo_train.py task=SRLBot wandb_project=TRO_SRL_Evo experiment=SRL_bot_v5_s2  headless=True wandb_activate=True max_iterations=3000  task.env.asset.assetFileName="mjcf/srl_bot/srl_bot_inversed_v5.xml"  train.params.config.a_sym_loss_coef=0.0  checkpoint=runs/SRL_bot_v5_s1_22-18-50-44/nn/SRL_bot_v5_s1.pth  task.env.orientation_reward_scale=5  task.env.progress_reward_scale=0.0 task.env.alive_reward_scale=0.0;  
