...
# humanoid AMP check
python SRL_Evo_train.py task=HumanoidAMPSRLGym_s1 test=True  num_envs=4   checkpoint=runs/SRL_HRI_23-14-38-18/nn/SRL_HRI_23-14-38-27_500.pth  sim_device=cuda:0 rl_device=cuda:0  task.env.asset.assetFileName='mjcf/humanoid_srl_v3/hsrl_mode1_v3_s1.xml'
...
# train srl hri 静止站立
python SRL_Evo_train.py task=SRL_HRI headless=True wandb_project=SRL_Evo wandb_activate=True experiment=SRL_HRI   max_iterations=1000   train.params.config.humanoid_checkpoint=runs/AMP_Pretrain_Default_19-15-17-44/nn/AMP_Pretrain_Default_19-15-17-54.pth   train.params.config.sym_loss_coef=0.0 ;  
...
# srl hri test
python SRL_Evo_train.py test=True task=SRL_HRI  num_envs=4   checkpoint=runs/SRL_HRI_24-16-03-56/nn/SRL_HRI_24-16-04-07_1000.pth
